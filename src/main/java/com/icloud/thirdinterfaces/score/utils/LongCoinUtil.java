...
//                return result;
     ...
     * @return
     */
    public LongQueryEntity getQueryEntity(String openid,String fromType){
     ...
     * @return
     */
    public LongChargeEntity getChargeEntity(String openid,String chargeAmount,String fromType){
     ...
     * @return
     */
    public LongConsumeEntity getComsueEntity(String openid, String consumeamount,String fromType){
     ...
     * @return
     */
    public LongChargeEntity getSpecifyChargeEntity(String openid,String chargeAmount,String fromType){
        LongChargeEntity entity = new LongChargeEntity();
